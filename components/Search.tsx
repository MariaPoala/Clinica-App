...
function HighlightQuery({ text, query }:any) {
  return (
    <Highlighter
...
function SearchResult({ result, autocomplete, collection, query }:any) {
  let id = useId()
...
function SearchResults({ autocomplete, query, collection }:any) {
  ...
  return (
    <ul role="list" {...autocomplete.getListProps()}>
      {collection.items.map((result:any) => (
        <SearchResult
          key={result.url}
          result={result}
...
const SearchInput = forwardRef(function SearchInput(
  { autocomplete, autocompleteState, onClose }:any,
  inputRef
) {
