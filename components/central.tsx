...
export const navigation = [
    {
        ...
        links: [
            ...
            { title: 'Servicio II', href: '/docs/installation' },
        ],
    },
    {
        title: 'Grupo II',
...
//     <header
//       className={clsx(
//         'sticky top-0 z-50 flex flex-wrap items-center justify-between bg-blue-600 px-4 py-5 shadow-md shadow-slate-900/5 transition duration-500 dark:shadow-none sm:px-6 lg:px-8',
//         isScrolled
...
function useTableOfContents(tableOfContents: any) {
    // let [currentSection, setCurrentSection] = useState(tableOfContents.tableOfContents[0]?.id)
...
export default function Layout({ children, title, tableOfContents }: any) {
    ...
    return (
        <>
            ...
            <div className="relative mx-auto flex max-w-8xl justify-center sm:px-2 lg:px-8 xl:px-12 bg-red-400">
